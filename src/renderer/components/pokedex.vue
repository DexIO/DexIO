<template lang="html">
  <div>
    ...
    <div class="title"><h1>Fichas técnicas</h1></div>
    <div class="wrap">
    		<input type="radio" name="view-filter" id="list-view" class="list-view-radio view-radio" checked><label id="list" for="list-view"><i  class="fa fa-list-ul"></i></label>

    		<input type="radio" name="view-filter" id="grid-view" class="grid-view-radio view-radio"><label id="grid" for="grid-view"><i class="fa fa-th"></i></label>
    <div class="">
      <searchbar id="pokedex"></searchbar>
    </div>
        ...
        <img src="../assets/assets/img/5.png">
          ...
          <h5>Pokémon llama</h5>
					<p><fuego></fuego> <volador></volador></p>
				</div>
			</article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <p><bicho></bicho> <volador></volador></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <h5>Pokémon ratón</h5>
          <p><siniestro></siniestro> <normal></normal></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <h5>Pokémon ratón</h5>
          <p><electrico></electrico> <psiquico></psiquico></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <p><veneno></veneno> <tierra></tierra></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <p><veneno></veneno> <volador></volador></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <p><planta></planta> <veneno></veneno></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <h5>Pokémon roca</h5>
          <p><roca></roca> <electrico></electrico></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <p><agua></agua> <psiquico></psiquico></p>
        </div>
      </article>
      ...
      <article class="block-item">
        ...
        <div class="entry-content">
          ...
          <h5>Pokémon imán</h5>
          <p><electrico></electrico> <acero></acero></p>
        </div>
      </article>
